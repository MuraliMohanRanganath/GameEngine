...
namespace Engine
{
	...
	bool CollisionCheck::checkCollisions(Actor* A, Actor* B, float dt, Collision & collisionInfo)
	{
		...
		Matrix4 actorAToWorld = Matrix4::CreateTranslationCV(A->getGameObject()->getPosition())* Matrix4::CreateZRotationCV(A->getGameObject()->getRotation());
		Matrix4 actorBToWorld = Matrix4::CreateTranslationCV(B->getGameObject()->getPosition()) *Matrix4::CreateZRotationCV(B->getGameObject()->getRotation());
		...
		Vector4 collisionAxis = Matrix4::CreateZRotationCV(A->getGameObject()->getRotation()).Col(0).getUnitVector();
		...
		collisionAxis = Matrix4::CreateZRotationCV(A->getGameObject()->getRotation()).Col(1).getUnitVector();
    if (!checkForAxisCollisions(start, end, ACenterInB.getY(), relativeVeloctityAInB.getY(), axisClose, axisOpen))
		...
		collisionAxis = Matrix4::CreateZRotationCV(B->getGameObject()->getRotation()).Col(0).getUnitVector();
		...
		collisionAxis = Matrix4::CreateZRotationCV(B->getGameObject()->getRotation()).Col(1).getUnitVector();
